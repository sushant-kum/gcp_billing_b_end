 ...
 * @create date 2019-12-08 18:08:45
 * @modify date 2019-12-08 18:08:45
 * @desc Handle`GET /api/users/min`
 */
...
/**
 * Handler for handling `GET /api/users/min`
 * Get min details for all users
 *
