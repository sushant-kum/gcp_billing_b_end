 ...
 * @create date 2019-12-08 18:52:59
 * @modify date 2019-12-08 18:52:59
 * @desc Handle `PUT /api/users/:user_id`
 */
...
/**
 * Handler for handling `PUT /api/users/:user_id`
 * Update user details with _id = `:user_id`
 *
