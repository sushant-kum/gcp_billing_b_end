 ...
 * @create date 2019-12-08 18:55:53
 * @modify date 2019-12-08 18:55:53
...
if (process.env && process.env.NODE_ENV === 'production') {
  logs_dir = path.join('/tmp', 'gcp_billing_b_end', 'logs');
} else {
...
// Create and append new session to log files
...
/**
 * Desensitize `log_items` of sensitive data
 *
 * @author Sushant Kumar <sushant.kum96@gmail.com>
 * @param {any[]} log_items
 * @returns
 */
function desesitize(log_items: any[]) {
...
/**
 * Logging function, loggin level: `log`
 *
 * @author Sushant Kumar <sushant.kum96@gmail.com>
 * @export
 * @param {any[]} args
...
/**
 * Logging function, loggin level: `info`
 *
 * @author Sushant Kumar <sushant.kum96@gmail.com>
 * @export
 * @param {any[]} args
...
/**
 * Logging function, loggin level: `warn`
 *
 * @author Sushant Kumar <sushant.kum96@gmail.com>
 * @export
 * @param {any[]} args
...
/**
 * Logging function, loggin level: `error`
 *
 * @author Sushant Kumar <sushant.kum96@gmail.com>
 * @export
 * @param {any[]} args
